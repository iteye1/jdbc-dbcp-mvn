...
public class GetDataServlet extends HttpServlet {
  ...
  private SimpleDAO _dao;
  private static final String DISPATCH_DATA_NAME = "DATA";
  private static final Logger _log = Logger.getLogger(GetDataServlet.class);
  ...
  public void init(ServletConfig cfg) throws ServletException {
    ...
    _dao = (SimpleDAO) ObjectRegistry.getInstance().get(
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    String forward = null;
    try {
      final Collection<SimpleDTO> result = _dao.getData();
      log("GetData: collection contains " + result.size() + " elements.");
      map.put("Items", result);
      forward = _DISPATCH_SUCCESS;
    } catch (Throwable t) {
      map.put("Message", t.getMessage());
      map.put("Throwable", t);
      _log.error("Problem fetching data", t);
